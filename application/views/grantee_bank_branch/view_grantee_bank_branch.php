    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'grantee banks branches detail')); ?></h3>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit grantee bank branch')); ?></h4>
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('grantee_bank_branch/get_grantee_bank_branch/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('grantee_bank_branch/add_grantee_bank_branch') ?>";
      }
      else
      {
        url = "<?php echo site_url('grantee_bank_branch/update_grantee_bank_branch') ?>";
      }
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('grantee_bank_branch/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
