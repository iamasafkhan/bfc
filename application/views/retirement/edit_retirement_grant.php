                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" class="validate[required]" <?php if($all['retirement_attach'] == 'No') { echo 'checked'; } ?> name="retirement_attach" id="retirement_attach" value="No"> No
                                    <input type="radio" class="validate[required]" <?php if($all['retirement_attach'] == 'Yes') { echo 'checked'; } ?> name="retirement_attach" id="retirement_attach" value="Yes"> Yes
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" class="validate[required]" <?php if($all['ppo_attach'] == 'No') { echo 'checked'; } ?> name="ppo_attach" id="ppo_attach" value="No"> No
                                    <input type="radio" class="validate[required]" <?php if($all['ppo_attach'] == 'Yes') { echo 'checked'; } ?> name="ppo_attach" id="ppo_attach" value="Yes"> Yes
