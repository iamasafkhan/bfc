...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('bfc_bank_branch/get_bfc_bank_branch/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('bfc_bank_branch/add_bfc_bank_branch') ?>";
      }
      else
      {
        url = "<?php echo site_url('bfc_bank_branch/update_bfc_bank_branch') ?>";
      }
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('bfc_bank_branch/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
