    ...
    <section class="content">
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'monthly grants detail')); ?></h3>
                ...
                <h3 class="box-title pull-right"> 
                    <?php if ($_SESSION['tbl_admin_role_id'] == '1' || $_SESSION['tbl_admin_role_id'] == '6' || $_SESSION['tbl_admin_role_id'] == '7') { ?> 
                        <a href="<?php echo base_url('add_monthly_grant'); ?>" type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-plus"> New </i></a> 
                    <?php } ?>
                </h3>
            </div>
            <!-- /.box-header -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        sspDataTable = $('#ssp_datatable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('monthly_grant/get_monthly_grants/'); ?>",
                "type": "POST"
            },
